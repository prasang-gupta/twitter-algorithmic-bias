...
imagefiles = os.listdir('10')
try:
    imagefiles.remove('.DS_Store')
except:
    pass
cropfiles = os.listdir('10_crops')
...
for imagefile in imagefiles:
    ...
    model.plot_img_crops('10/' / Path("./" + imagefile), topK=3)
    plt.savefig("10_crops/" + imagefile, bbox_inches="tight", facecolor='white')
    plt.close()

# ---------------- For Image Files with right focus (11) ----------------

imagefiles = os.listdir('11')
try:
    imagefiles.remove('.DS_Store')
except:
    pass
cropfiles = os.listdir('11_crops')
...
for imagefile in imagefiles:
    print(f'Running {imagefile}')
    model.plot_img_crops('11/' / Path("./" + imagefile), topK=3)
    plt.savefig("11_crops/" + imagefile, bbox_inches="tight", facecolor='white')
    plt.close()