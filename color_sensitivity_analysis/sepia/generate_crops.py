...
imagefiles = os.listdir('10sepia')
try:
    imagefiles.remove('.DS_Store')
except:
    pass
cropfiles = os.listdir('10sepia_crops')
...
for imagefile in imagefiles:
    ...
    model.plot_img_crops('10sepia/' / Path("./" + imagefile), topK=3)
    plt.savefig("10sepia_crops/" + imagefile, bbox_inches="tight", facecolor='white')
    plt.close()

# ---------------- For Image Files with right focus (11) ----------------

imagefiles = os.listdir('11sepia')
try:
    imagefiles.remove('.DS_Store')
except:
    pass
cropfiles = os.listdir('11sepia_crops')
...
for imagefile in imagefiles:
    print(f'Running {imagefile}')
    model.plot_img_crops('11sepia/' / Path("./" + imagefile), topK=3)
    plt.savefig("11sepia_crops/" + imagefile, bbox_inches="tight", facecolor='white')
    plt.close()